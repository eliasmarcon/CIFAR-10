...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--base_dataset_path', default="./cifar-10", type=str,
                        help='base path to the dataset (default: ./cifar-10)')
    ...
    parser.add_argument('-b', '--batch_size', default=256, type=int,
                        help='batch size to train model (default: 256)')
